            ...
            <div style="flex:1;min-width:200px">
              ...
              <div style="margin-bottom:15px">
                ...
                <div style="display:flex;gap:10px">
                  <div style="border:1px solid #ddd;padding:5px 10px;cursor:pointer">36</div>
                  <div style="border:1px solid #ddd;padding:5px 10px;cursor:pointer">37</div>
                  <div style="border:1px solid #ddd;padding:5px 10px;cursor:pointer">38</div>
                  <div style="border:1px solid #ddd;padding:5px 10px;cursor:pointer">39</div>
                  <div style="border:1px solid #ddd;padding:5px 10px;cursor:pointer">40</div>
                </div>
              </div>
